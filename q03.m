%Questão 03
% Um sinal senoidal exponencialmente amortecido é definido por:
% x(t) = 20 sen(2pi * 1000t - pi/3)*e^(-at).
% Em que o parametro exponencial a é variavel; ele assume o seguinte
...
% 
% Faça com que plote as 3 figuras em cada ocasião e diga o que aconteceu
